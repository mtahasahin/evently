    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex flex-col">
                        ...
                        <FormGroup>
                            <div className="w-full">
                                <TextInput label="EMAIL" name="email" register={register} error={errors.email}/>
                                <ErrorMessage messages={errors.email?.message}/>
                            </div>
                        </FormGroup>
                        <FormGroup>
                            <div className="w-full">
                                <TextInput label="YOUR NAME" name="profile.name" register={register}
                                           error={errors.profile?.name}/>
                                <ErrorMessage messages={errors.profile?.name?.message}/>
                            </div>
                            <div className="w-full">
                                <TextInput label="USERNAME" name="username" register={register}
                                           error={errors.username}/>
                                <ErrorMessage messages={errors.username?.message}/>
                            </div>
                        </FormGroup>
                        <FormGroup>
                            <DatePicker label="DATE OF BIRTH" name="profile.dateOfBirth" control={control}/>
                            <TextInput label="WHERE DO YOU LIVE" name="profile.location" register={register}/>
                        </FormGroup>
                        <FormGroup>
                            <Select options={profileVisibilityOptions}
                        ...
                        <FormGroup>
                            <TextArea label="ABOUT" name="profile.about" register={register}/>
                        </FormGroup>
                    </div>
                </div>
            ...
            <div className="shadow-sm">
                <div className="bg-white rounded-t h-full w-full py-10 px-8">
                    <div className="flex flex-col">
                        <h1 className="text-3xl font-bold mb-8">Links and Social Networks</h1>
                        <FormGroup>
                            <TextInput label="WEBSITE URL" name="profile.websiteUrl" register={register}/>
                            <SocialMediaInput precedingUrl="facebook.com/" label="FACEBOOK USERNAME"
                                              name="profile.facebookUsername" register={register}/>
                        </FormGroup>
                        <FormGroup>
                            <SocialMediaInput precedingUrl="twitter.com/" label="TWITTER USERNAME"
                                              name="profile.twitterUsername" register={register}/>
                            <SocialMediaInput precedingUrl="instagram.com/" label="INSTAGRAM USERNAME"
                                              name="profile.instagramUsername" register={register}/>
                        </FormGroup>
                        <FormGroup>
                            <SocialMediaInput precedingUrl="github.com/" label="GITHUB USERNAME"
                                              name="profile.githubUsername" register={register}/>
                            <div className="w-full"/>
                        </FormGroup>
                    </div>
                </div>
