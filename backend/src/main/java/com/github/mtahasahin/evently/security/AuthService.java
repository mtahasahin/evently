...
public class AuthService {
    ...
    public AuthenticationResponse registerUser(RegisterRequest registerRequest) {
        ...
        try {
            var url = fileStorageService.uploadFile(s3Key, new ByteArrayInputStream(ImageUtils.toByteArray(ImageUtils.createProfileImageFromName(registerRequest.getName(), 300), "jpg")));
